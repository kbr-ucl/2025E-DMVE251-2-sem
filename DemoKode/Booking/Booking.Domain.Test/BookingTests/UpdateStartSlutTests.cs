...
public class UpdateStartSlutTests
{
    ...
    [TestCase("2025-02-03", "2025-02-02", "2025-02-01")] // Parameteriseret test
    ...
    [TestCase("2025-01-02", "2025-01-03", "2025-02-01")]
    [TestCase("2025-01-02", "2025-01-03", "2025-01-02")] // Parameteriseret test
    ...
    [TestCase("2025-09-19", "2025-09-20", "2025-01-01")]
    [TestCase("2025-09-19", "2025-09-30", "2025-09-18")]
        ...
        string slutStr, string nowStr)
    {
        ...
        bookingOverlapCheckMock
            .Setup(s => 
                s.HasOverlap(It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int?>()))
            .Returns(false);
        ...
        // Act
        sut.UpdateStartSlut(start, slut, bookingOverlapCheckMock.Object, nowMock.Object);
...
public class BookingTestFixture : Entity.Booking
{
    ...
    {
        get => base.StartTid;
        set => base.StartTid = value;
    }

    public new DateTime SlutTid
    {
        get => base.SlutTid;
        set => base.StartTid = value;
    }

    public new Kunde Kunde
    {
        get => base.Kunde;
        set => base.Kunde = value;
    }
}