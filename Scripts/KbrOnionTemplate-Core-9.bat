...
rem dotnet new mvc -f net9.0 -au Individual -uld -o %app%.Mvc
dotnet new webapi -f net9.0 -au None -o %app%.Api
dotnet new classlib -f net9.0 -o %app%.Application
dotnet new classlib -f net9.0 -o %app%.Domain
dotnet new xunit -f net9.0 -o %app%.Domain.Test
dotnet new classlib -f net9.0 -o %app%.Infrastructure
dotnet new classlib -f net9.0 -o %app%.DatabaseMigration
...
dotnet add %app%.Api/%app%.Api.csproj package AutoMapper
...
dotnet add %app%.Application/%app%.Application.csproj package AutoMapper
